...
if(isset($_POST['submit']))
{
  ...
  $query="INSERT INTO signup (fullname, username, email, phonenumber, gender, passwords , confirmpassword) VALUES ('$fname', '$uname', '$email','$phone', '$genders', '$password','$confirmpassword')";
  
  $email_query="SELECT * FROM signup WHERE email='$email'";
  $uname_query="SELECT * FROM signup WHERE username='$uname'";
  $check_email=mysqli_query($conn, $email_query);
  $check_uname=mysqli_query($conn, $uname_query);
  ...
  else if(mysqli_num_rows($check_uname)>0){
    echo '<script>
...
<body>
  <div class="container cont2">
    ...
    <div class="content">
      <form id="formup" autocomplete="off" onsubmit="" method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="password" name="pass" id="passwords" placeholder="Enter your password" value="">
          </div>
          <div class="input-box">
            <span id="messagess">Confirm Password</span>
            <input type="password" name="cpass" id="passwordss" placeholder="Confirm your password" value="">
          </div>
        </div>
    ...
    <div>
      <button class="btn btn-default" name="submit" onclick=" return myfun()">REGISTERED</button>
      <br><br>
