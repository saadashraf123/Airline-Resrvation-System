...
if(isset($_POST['search']))
{
    $city1=$_POST['myCity1'];
    $city2=$_POST['myCity2'];
    $_SESSION['myCity1']=$city1;
    $_SESSION['myCity2']=$city2;
...
<body id="myPage" onload="pop()">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a id="loggedin" class="nav-link disabled" style="display:none;;" href="#">LOGIN</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="logout" href="index.php">LOGOUT</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="about" id="about">
        <div class="container-fluid">
            ...
            <br>
            <p class="aboutPara">
                The airline reservation website is a link between the customers i.e; travelers of tourists and principle
                suppliers such as tour airlines.<br>
                This website allows a customer to specify their travel requirement such as the city of departure,
                destination departure date return date and class of travel.<br>
                It contains information on schedules and fares and contains a database of reservations (or passenger
                    ...
                    <div class="container-fluid deal">
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <p>Get &nbsp<b id="off" style="color: brown;">50% off</b> on the <b id="changes"> child
                                    </b> seat.</p>
                            </div>
                ...
                <form action="" method="post" onsubmit="">
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            <?php
                                echo "<input class='form-control bg-white' type='text' id='name' value='".$user['fullname']."' readonly>";
                            ?>
                            <!-- <input class="form-control" id="name" name="name" value="Name" type="text" required> -->
                        </div>
                        <div class="col-sm-6 form-group">
                            <?php
                                echo "<input class='form-control bg-white' type='text' id='name' value='".$user['email']."' readonly>";
                            ?>
    ...
    <div class="map">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3618.066386031152!2d67.11264271500418!3d24.929808284021334!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb338b8d4494c91%3A0xf864ed97b4a8ec0e!2sNED%20University%20of%20Engineering%20and%20Technology!5e0!3m2!1sen!2s!4v1627838457050!5m2!1sen!2s"
            width="1350" margin-bottom="0px" height="450" style="border:0;" allowfullscreen="" loading="lazy">
        </iframe>
    </div>
