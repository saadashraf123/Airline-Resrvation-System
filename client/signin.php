...
if(!empty($_POST['login']))
{
    ...
    $query= "select * from signup where username= '$username' && passwords = '$password'";
    $result = mysqli_query($conn, $query);
    if($result){
        $count = mysqli_num_rows($result);
        if($count>0){
            $_SESSION['variable']=$count;
            ...
            <dive class="formWraper">
                ...
                <div class="formDiv">
                    ...
                    <form action="" method="post" autocomplete="off">
                        ...
                        <button class="btn btn-default" name="login" value="login" type="submit" onclick="">SIGN
                            IN</button>
                        <p class="text">Don't have an account? <a href="signup.php">REGESTER NOW!</a></p>
                </div>
                </form>
                ...
                <div class="welcomeDiv">
                    ...
                    <button class="btn" type="submit" value="" onclick="location.href = 'signup.php';"><b>REGESTER
                            NOW!</b></button>
